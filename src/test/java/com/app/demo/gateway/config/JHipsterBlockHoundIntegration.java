package com.app.demo.gateway.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.app.demo.gateway.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.app.demo.gateway.security.DomainUserDetailsService", "createSpringSecurityUser");
